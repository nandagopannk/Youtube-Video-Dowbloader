...
#download btn
downloadbtn = Button(root,text="Download Video",width=10,bg="red",fg="white",command=DownloadVideo)
downloadbtn.grid()

#developer Label
developerlabel = Label(root,text="Programming Buddies",font=("jost",15))
developerlabel.grid()
root.mainloop()
